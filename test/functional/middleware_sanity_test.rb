...
module GraphiteAPI::Tests
  module Functional
    class MiddlewareSanityTest < TestCase
      ...
      def setup
        @middleware_port = GraphiteAPI::Tests.random_non_repeating_port
        @mock_server_port = GraphiteAPI::Tests.random_non_repeating_port
        @data = []
        GraphiteAPI::Tests.stop_em_if_running
      end
